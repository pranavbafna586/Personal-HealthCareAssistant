...
def send_otp():
    ...
    server.starttls()
    server.login('albuswand586@gmail.com', 'xvld texg zrhe flkz')
    msg = 'Hello Your HealthCare OTP is ' + str(otp) + '\n' + 'Do not share OTP with anyone...'
    server.sendmail('albuswand586@gmail.com', email_input.get(), msg)
    server.quit()
...
root = Tk()
# bg image
bg_image = Image.open("D:/Projects/python/PersonalHealtCare Assistant/image.jpeg")
...
root.configure()
# image
img = Image.open("D:/Projects/python/PersonalHealtCare Assistant/2.jpg")
